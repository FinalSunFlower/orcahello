...
- **LiveHLS smoke** (Ubuntu): the external-stream check runs in its own ten-minute job and does not block pull-request feedback when the public stream is unavailable.
